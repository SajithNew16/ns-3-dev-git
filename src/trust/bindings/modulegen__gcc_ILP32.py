...
def module_init():
    root_module = Module('ns.trust', cpp_namespace='::ns3')
    return root_module
...
def register_types(module):
    ...
    ## trust-helper.h (module 'trust'): ns3::TrustHelper [class]
    module.add_class('TrustHelper', parent=root_module['ns3::Ipv4RoutingHelper'])
    ...
    ## Register a nested module for the namespace trust
    
    nested_module = module.add_cpp_namespace('trust')
    register_types_ns3_trust(nested_module)
...
def register_types_ns3_trust(module):
    root_module = module.get_root()
    
    ## trust-rtable.h (module 'trust'): ns3::trust::RouteFlags [enumeration]
    module.add_enum('RouteFlags', ['VALID', 'INVALID', 'IN_SEARCH'])
    ## trust-packet.h (module 'trust'): ns3::trust::MessageType [enumeration]
    module.add_enum('MessageType', ['TRUSTTYPE_RREQ', 'TRUSTTYPE_RREP', 'TRUSTTYPE_RERR', 'TRUSTTYPE_RREP_ACK'])
    ## trust-dpd.h (module 'trust'): ns3::trust::DuplicatePacketDetection [class]
    module.add_class('DuplicatePacketDetection')
    ## trust-id-cache.h (module 'trust'): ns3::trust::IdCache [class]
    module.add_class('IdCache')
    ## trust-neighbor.h (module 'trust'): ns3::trust::Neighbors [class]
    module.add_class('Neighbors')
    ## trust-neighbor.h (module 'trust'): ns3::trust::Neighbors::Neighbor [struct]
    module.add_class('Neighbor', outer_class=root_module['ns3::trust::Neighbors'])
    ## trust-rqueue.h (module 'trust'): ns3::trust::QueueEntry [class]
    module.add_class('QueueEntry')
    ## trust-rqueue.h (module 'trust'): ns3::trust::RequestQueue [class]
    module.add_class('RequestQueue')
    ## trust-packet.h (module 'trust'): ns3::trust::RerrHeader [class]
    module.add_class('RerrHeader', parent=root_module['ns3::Header'])
    ## trust-routing-protocol.h (module 'trust'): ns3::trust::RoutingProtocol [class]
    module.add_class('RoutingProtocol', parent=root_module['ns3::Ipv4RoutingProtocol'])
    ## trust-rtable.h (module 'trust'): ns3::trust::RoutingTable [class]
    module.add_class('RoutingTable')
    ## trust-rtable.h (module 'trust'): ns3::trust::RoutingTableEntry [class]
    module.add_class('RoutingTableEntry')
    ## trust-packet.h (module 'trust'): ns3::trust::RrepAckHeader [class]
    module.add_class('RrepAckHeader', parent=root_module['ns3::Header'])
    ## trust-packet.h (module 'trust'): ns3::trust::RrepHeader [class]
    module.add_class('RrepHeader', parent=root_module['ns3::Header'])
    ## trust-packet.h (module 'trust'): ns3::trust::RreqHeader [class]
    module.add_class('RreqHeader', parent=root_module['ns3::Header'])
    ## trust-packet.h (module 'trust'): ns3::trust::TypeHeader [class]
...
def register_methods(root_module):
    ...
    register_Ns3TrustHelper_methods(root_module, root_module['ns3::TrustHelper'])
    ...
    register_Ns3TrustDuplicatePacketDetection_methods(root_module, root_module['ns3::trust::DuplicatePacketDetection'])
    register_Ns3TrustIdCache_methods(root_module, root_module['ns3::trust::IdCache'])
    register_Ns3TrustNeighbors_methods(root_module, root_module['ns3::trust::Neighbors'])
    register_Ns3TrustNeighborsNeighbor_methods(root_module, root_module['ns3::trust::Neighbors::Neighbor'])
    register_Ns3TrustQueueEntry_methods(root_module, root_module['ns3::trust::QueueEntry'])
    register_Ns3TrustRequestQueue_methods(root_module, root_module['ns3::trust::RequestQueue'])
    register_Ns3TrustRerrHeader_methods(root_module, root_module['ns3::trust::RerrHeader'])
    register_Ns3TrustRoutingProtocol_methods(root_module, root_module['ns3::trust::RoutingProtocol'])
    register_Ns3TrustRoutingTable_methods(root_module, root_module['ns3::trust::RoutingTable'])
    register_Ns3TrustRoutingTableEntry_methods(root_module, root_module['ns3::trust::RoutingTableEntry'])
    register_Ns3TrustRrepAckHeader_methods(root_module, root_module['ns3::trust::RrepAckHeader'])
    register_Ns3TrustRrepHeader_methods(root_module, root_module['ns3::trust::RrepHeader'])
    register_Ns3TrustRreqHeader_methods(root_module, root_module['ns3::trust::RreqHeader'])
    register_Ns3TrustTypeHeader_methods(root_module, root_module['ns3::trust::TypeHeader'])
    return
...
def register_Ns3TrustHelper_methods(root_module, cls):
    ## trust-helper.h (module 'trust'): ns3::TrustHelper::TrustHelper(ns3::TrustHelper const & arg0) [constructor]
    cls.add_constructor([param('ns3::TrustHelper const &', 'arg0')])
    ## trust-helper.h (module 'trust'): ns3::TrustHelper::TrustHelper() [constructor]
    cls.add_constructor([])
    ## trust-helper.h (module 'trust'): int64_t ns3::TrustHelper::AssignStreams(ns3::NodeContainer c, int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('ns3::NodeContainer', 'c'), param('int64_t', 'stream')])
    ## trust-helper.h (module 'trust'): ns3::TrustHelper * ns3::TrustHelper::Copy() const [member function]
    cls.add_method('Copy', 
                   'ns3::TrustHelper *', 
                   [], 
                   is_const=True, is_virtual=True)
    ## trust-helper.h (module 'trust'): ns3::Ptr<ns3::Ipv4RoutingProtocol> ns3::TrustHelper::Create(ns3::Ptr<ns3::Node> node) const [member function]
    cls.add_method('Create', 
                   'ns3::Ptr< ns3::Ipv4RoutingProtocol >', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_const=True, is_virtual=True)
    ## trust-helper.h (module 'trust'): void ns3::TrustHelper::Set(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('Set', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    return
...
def register_Ns3TrustDuplicatePacketDetection_methods(root_module, cls):
    ## trust-dpd.h (module 'trust'): ns3::trust::DuplicatePacketDetection::DuplicatePacketDetection(ns3::trust::DuplicatePacketDetection const & arg0) [constructor]
    cls.add_constructor([param('ns3::trust::DuplicatePacketDetection const &', 'arg0')])
    ## trust-dpd.h (module 'trust'): ns3::trust::DuplicatePacketDetection::DuplicatePacketDetection(ns3::Time lifetime) [constructor]
    cls.add_constructor([param('ns3::Time', 'lifetime')])
    ## trust-dpd.h (module 'trust'): ns3::Time ns3::trust::DuplicatePacketDetection::GetLifetime() const [member function]
    cls.add_method('GetLifetime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## trust-dpd.h (module 'trust'): bool ns3::trust::DuplicatePacketDetection::IsDuplicate(ns3::Ptr<const ns3::Packet> p, ns3::Ipv4Header const & header) [member function]
    cls.add_method('IsDuplicate', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p'), param('ns3::Ipv4Header const &', 'header')])
    ## trust-dpd.h (module 'trust'): void ns3::trust::DuplicatePacketDetection::SetLifetime(ns3::Time lifetime) [member function]
    cls.add_method('SetLifetime', 
                   'void', 
                   [param('ns3::Time', 'lifetime')])
    return

def register_Ns3TrustIdCache_methods(root_module, cls):
    ## trust-id-cache.h (module 'trust'): ns3::trust::IdCache::IdCache(ns3::trust::IdCache const & arg0) [constructor]
    cls.add_constructor([param('ns3::trust::IdCache const &', 'arg0')])
    ## trust-id-cache.h (module 'trust'): ns3::trust::IdCache::IdCache(ns3::Time lifetime) [constructor]
    cls.add_constructor([param('ns3::Time', 'lifetime')])
    ## trust-id-cache.h (module 'trust'): ns3::Time ns3::trust::IdCache::GetLifeTime() const [member function]
    cls.add_method('GetLifeTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## trust-id-cache.h (module 'trust'): uint32_t ns3::trust::IdCache::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## trust-id-cache.h (module 'trust'): bool ns3::trust::IdCache::IsDuplicate(ns3::Ipv4Address addr, uint32_t id) [member function]
    cls.add_method('IsDuplicate', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'addr'), param('uint32_t', 'id')])
    ## trust-id-cache.h (module 'trust'): void ns3::trust::IdCache::Purge() [member function]
    cls.add_method('Purge', 
                   'void', 
                   [])
    ## trust-id-cache.h (module 'trust'): void ns3::trust::IdCache::SetLifetime(ns3::Time lifetime) [member function]
    cls.add_method('SetLifetime', 
                   'void', 
                   [param('ns3::Time', 'lifetime')])
    return

def register_Ns3TrustNeighbors_methods(root_module, cls):
    ## trust-neighbor.h (module 'trust'): ns3::trust::Neighbors::Neighbors(ns3::trust::Neighbors const & arg0) [constructor]
    cls.add_constructor([param('ns3::trust::Neighbors const &', 'arg0')])
    ## trust-neighbor.h (module 'trust'): ns3::trust::Neighbors::Neighbors(ns3::Time delay) [constructor]
    cls.add_constructor([param('ns3::Time', 'delay')])
    ## trust-neighbor.h (module 'trust'): void ns3::trust::Neighbors::AddArpCache(ns3::Ptr<ns3::ArpCache> a) [member function]
    cls.add_method('AddArpCache', 
                   'void', 
                   [param('ns3::Ptr< ns3::ArpCache >', 'a')])
    ## trust-neighbor.h (module 'trust'): void ns3::trust::Neighbors::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## trust-neighbor.h (module 'trust'): void ns3::trust::Neighbors::DelArpCache(ns3::Ptr<ns3::ArpCache> a) [member function]
    cls.add_method('DelArpCache', 
                   'void', 
                   [param('ns3::Ptr< ns3::ArpCache >', 'a')])
    ## trust-neighbor.h (module 'trust'): ns3::Callback<void, ns3::Ipv4Address, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ns3::trust::Neighbors::GetCallback() const [member function]
    cls.add_method('GetCallback', 
                   ...
                   [], 
                   is_const=True)
    ## trust-neighbor.h (module 'trust'): ns3::Time ns3::trust::Neighbors::GetExpireTime(ns3::Ipv4Address addr) [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [param('ns3::Ipv4Address', 'addr')])
    ## trust-neighbor.h (module 'trust'): ns3::Callback<void, const ns3::WifiMacHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ns3::trust::Neighbors::GetTxErrorCallback() const [member function]
    cls.add_method('GetTxErrorCallback', 
                   ...
                   [], 
                   is_const=True)
    ## trust-neighbor.h (module 'trust'): bool ns3::trust::Neighbors::IsNeighbor(ns3::Ipv4Address addr) [member function]
    cls.add_method('IsNeighbor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'addr')])
    ## trust-neighbor.h (module 'trust'): void ns3::trust::Neighbors::Purge() [member function]
    cls.add_method('Purge', 
                   'void', 
                   [])
    ## trust-neighbor.h (module 'trust'): void ns3::trust::Neighbors::ScheduleTimer() [member function]
    cls.add_method('ScheduleTimer', 
                   'void', 
                   [])
    ## trust-neighbor.h (module 'trust'): void ns3::trust::Neighbors::SetCallback(ns3::Callback<void, ns3::Ipv4Address, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> cb) [member function]
    ...
    ## trust-neighbor.h (module 'trust'): void ns3::trust::Neighbors::Update(ns3::Ipv4Address addr, ns3::Time expire) [member function]
    cls.add_method('Update', 
                   'void', 
                   [param('ns3::Ipv4Address', 'addr'), param('ns3::Time', 'expire')])
    return

def register_Ns3TrustNeighborsNeighbor_methods(root_module, cls):
    ## trust-neighbor.h (module 'trust'): ns3::trust::Neighbors::Neighbor::Neighbor(ns3::trust::Neighbors::Neighbor const & arg0) [constructor]
    cls.add_constructor([param('ns3::trust::Neighbors::Neighbor const &', 'arg0')])
    ## trust-neighbor.h (module 'trust'): ns3::trust::Neighbors::Neighbor::Neighbor(ns3::Ipv4Address ip, ns3::Mac48Address mac, ns3::Time t) [constructor]
    cls.add_constructor([param('ns3::Ipv4Address', 'ip'), param('ns3::Mac48Address', 'mac'), param('ns3::Time', 't')])
    ## trust-neighbor.h (module 'trust'): ns3::trust::Neighbors::Neighbor::close [variable]
    cls.add_instance_attribute('close', 'bool', is_const=False)
    ## trust-neighbor.h (module 'trust'): ns3::trust::Neighbors::Neighbor::m_expireTime [variable]
    cls.add_instance_attribute('m_expireTime', 'ns3::Time', is_const=False)
    ## trust-neighbor.h (module 'trust'): ns3::trust::Neighbors::Neighbor::m_hardwareAddress [variable]
    cls.add_instance_attribute('m_hardwareAddress', 'ns3::Mac48Address', is_const=False)
    ## trust-neighbor.h (module 'trust'): ns3::trust::Neighbors::Neighbor::m_neighborAddress [variable]
    cls.add_instance_attribute('m_neighborAddress', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3TrustQueueEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## trust-rqueue.h (module 'trust'): ns3::trust::QueueEntry::QueueEntry(ns3::trust::QueueEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::trust::QueueEntry const &', 'arg0')])
    ## trust-rqueue.h (module 'trust'): ns3::trust::QueueEntry::QueueEntry(ns3::Ptr<const ns3::Packet> pa=0, ns3::Ipv4Header const & h=ns3::Ipv4Header(), ns3::trust::QueueEntry::UnicastForwardCallback ucb=::ns3::Callback<void, ns3::Ptr<ns3::Ipv4Route>, ns3::Ptr<const ns3::Packet>, const ns3::Ipv4Header &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>( ), ns3::trust::QueueEntry::ErrorCallback ecb=::ns3::Callback<void, ns3::Ptr<const ns3::Packet>, const ns3::Ipv4Header &, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>( ), ns3::Time exp=ns3::Simulator::Now()) [constructor]
    cls.add_constructor([param('ns3::Ptr< ns3::Packet const >', 'pa', default_value='0'), param('ns3::Ipv4Header const &', 'h', default_value='ns3::Ipv4Header()'), param('ns3::trust::QueueEntry::UnicastForwardCallback', 'ucb', default_value='::ns3::Callback<void, ns3::Ptr<ns3::Ipv4Route>, ns3::Ptr<const ns3::Packet>, const ns3::Ipv4Header &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>( )'), param('ns3::trust::QueueEntry::ErrorCallback', 'ecb', default_value='::ns3::Callback<void, ns3::Ptr<const ns3::Packet>, const ns3::Ipv4Header &, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>( )'), param('ns3::Time', 'exp', default_value='ns3::Simulator::Now()')])
    ## trust-rqueue.h (module 'trust'): ns3::trust::QueueEntry::ErrorCallback ns3::trust::QueueEntry::GetErrorCallback() const [member function]
    cls.add_method('GetErrorCallback', 
                   'ns3::trust::QueueEntry::ErrorCallback', 
                   [], 
                   is_const=True)
    ## trust-rqueue.h (module 'trust'): ns3::Time ns3::trust::QueueEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## trust-rqueue.h (module 'trust'): ns3::Ipv4Header ns3::trust::QueueEntry::GetIpv4Header() const [member function]
    cls.add_method('GetIpv4Header', 
                   'ns3::Ipv4Header', 
                   [], 
                   is_const=True)
    ## trust-rqueue.h (module 'trust'): ns3::Ptr<const ns3::Packet> ns3::trust::QueueEntry::GetPacket() const [member function]
    cls.add_method('GetPacket', 
                   'ns3::Ptr< ns3::Packet const >', 
                   [], 
                   is_const=True)
    ## trust-rqueue.h (module 'trust'): ns3::trust::QueueEntry::UnicastForwardCallback ns3::trust::QueueEntry::GetUnicastForwardCallback() const [member function]
    cls.add_method('GetUnicastForwardCallback', 
                   'ns3::trust::QueueEntry::UnicastForwardCallback', 
                   [], 
                   is_const=True)
    ## trust-rqueue.h (module 'trust'): void ns3::trust::QueueEntry::SetErrorCallback(ns3::trust::QueueEntry::ErrorCallback ecb) [member function]
    cls.add_method('SetErrorCallback', 
                   'void', 
                   [param('ns3::Ipv4RoutingProtocol::ErrorCallback', 'ecb')])
    ## trust-rqueue.h (module 'trust'): void ns3::trust::QueueEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## trust-rqueue.h (module 'trust'): void ns3::trust::QueueEntry::SetIpv4Header(ns3::Ipv4Header h) [member function]
    cls.add_method('SetIpv4Header', 
                   'void', 
                   [param('ns3::Ipv4Header', 'h')])
    ## trust-rqueue.h (module 'trust'): void ns3::trust::QueueEntry::SetPacket(ns3::Ptr<const ns3::Packet> p) [member function]
    cls.add_method('SetPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p')])
    ## trust-rqueue.h (module 'trust'): void ns3::trust::QueueEntry::SetUnicastForwardCallback(ns3::trust::QueueEntry::UnicastForwardCallback ucb) [member function]
    cls.add_method('SetUnicastForwardCallback', 
                   'void', 
                   [param('ns3::Ipv4RoutingProtocol::UnicastForwardCallback', 'ucb')])
    return

def register_Ns3TrustRequestQueue_methods(root_module, cls):
    ## trust-rqueue.h (module 'trust'): ns3::trust::RequestQueue::RequestQueue(ns3::trust::RequestQueue const & arg0) [constructor]
    cls.add_constructor([param('ns3::trust::RequestQueue const &', 'arg0')])
    ## trust-rqueue.h (module 'trust'): ns3::trust::RequestQueue::RequestQueue(uint32_t maxLen, ns3::Time routeToQueueTimeout) [constructor]
    cls.add_constructor([param('uint32_t', 'maxLen'), param('ns3::Time', 'routeToQueueTimeout')])
    ## trust-rqueue.h (module 'trust'): bool ns3::trust::RequestQueue::Dequeue(ns3::Ipv4Address dst, ns3::trust::QueueEntry & entry) [member function]
    cls.add_method('Dequeue', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::trust::QueueEntry &', 'entry')])
    ## trust-rqueue.h (module 'trust'): void ns3::trust::RequestQueue::DropPacketWithDst(ns3::Ipv4Address dst) [member function]
    cls.add_method('DropPacketWithDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## trust-rqueue.h (module 'trust'): bool ns3::trust::RequestQueue::Enqueue(ns3::trust::QueueEntry & entry) [member function]
    cls.add_method('Enqueue', 
                   'bool', 
                   [param('ns3::trust::QueueEntry &', 'entry')])
    ## trust-rqueue.h (module 'trust'): bool ns3::trust::RequestQueue::Find(ns3::Ipv4Address dst) [member function]
    cls.add_method('Find', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## trust-rqueue.h (module 'trust'): uint32_t ns3::trust::RequestQueue::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## trust-rqueue.h (module 'trust'): ns3::Time ns3::trust::RequestQueue::GetQueueTimeout() const [member function]
    cls.add_method('GetQueueTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## trust-rqueue.h (module 'trust'): uint32_t ns3::trust::RequestQueue::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## trust-rqueue.h (module 'trust'): void ns3::trust::RequestQueue::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## trust-rqueue.h (module 'trust'): void ns3::trust::RequestQueue::SetQueueTimeout(ns3::Time t) [member function]
    cls.add_method('SetQueueTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    return

def register_Ns3TrustRerrHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## trust-packet.h (module 'trust'): ns3::trust::RerrHeader::RerrHeader(ns3::trust::RerrHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::trust::RerrHeader const &', 'arg0')])
    ## trust-packet.h (module 'trust'): ns3::trust::RerrHeader::RerrHeader() [constructor]
    cls.add_constructor([])
    ## trust-packet.h (module 'trust'): bool ns3::trust::RerrHeader::AddUnDestination(ns3::Ipv4Address dst, uint32_t seqNo) [member function]
    cls.add_method('AddUnDestination', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('uint32_t', 'seqNo')])
    ## trust-packet.h (module 'trust'): void ns3::trust::RerrHeader::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## trust-packet.h (module 'trust'): uint32_t ns3::trust::RerrHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## trust-packet.h (module 'trust'): uint8_t ns3::trust::RerrHeader::GetDestCount() const [member function]
    cls.add_method('GetDestCount', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## trust-packet.h (module 'trust'): ns3::TypeId ns3::trust::RerrHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## trust-packet.h (module 'trust'): bool ns3::trust::RerrHeader::GetNoDelete() const [member function]
    cls.add_method('GetNoDelete', 
                   'bool', 
                   [], 
                   is_const=True)
    ## trust-packet.h (module 'trust'): uint32_t ns3::trust::RerrHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## trust-packet.h (module 'trust'): static ns3::TypeId ns3::trust::RerrHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## trust-packet.h (module 'trust'): void ns3::trust::RerrHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## trust-packet.h (module 'trust'): bool ns3::trust::RerrHeader::RemoveUnDestination(std::pair<ns3::Ipv4Address, unsigned int> & un) [member function]
    cls.add_method('RemoveUnDestination', 
                   'bool', 
                   [param('std::pair< ns3::Ipv4Address, unsigned int > &', 'un')])
    ## trust-packet.h (module 'trust'): void ns3::trust::RerrHeader::Serialize(ns3::Buffer::Iterator i) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'i')], 
                   is_const=True, is_virtual=True)
    ## trust-packet.h (module 'trust'): void ns3::trust::RerrHeader::SetNoDelete(bool f) [member function]
    cls.add_method('SetNoDelete', 
                   'void', 
                   [param('bool', 'f')])
    return

def register_Ns3TrustRoutingProtocol_methods(root_module, cls):
    ## trust-routing-protocol.h (module 'trust'): ns3::trust::RoutingProtocol::RoutingProtocol(ns3::trust::RoutingProtocol const & arg0) [constructor]
    cls.add_constructor([param('ns3::trust::RoutingProtocol const &', 'arg0')])
    ## trust-routing-protocol.h (module 'trust'): ns3::trust::RoutingProtocol::RoutingProtocol() [constructor]
    cls.add_constructor([])
    ## trust-routing-protocol.h (module 'trust'): int64_t ns3::trust::RoutingProtocol::AssignStreams(int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('int64_t', 'stream')])
    ## trust-routing-protocol.h (module 'trust'): void ns3::trust::RoutingProtocol::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   is_virtual=True)
    ## trust-routing-protocol.h (module 'trust'): bool ns3::trust::RoutingProtocol::GetBroadcastEnable() const [member function]
    cls.add_method('GetBroadcastEnable', 
                   'bool', 
                   [], 
                   is_const=True)
    ## trust-routing-protocol.h (module 'trust'): bool ns3::trust::RoutingProtocol::GetDestinationOnlyFlag() const [member function]
    cls.add_method('GetDestinationOnlyFlag', 
                   'bool', 
                   [], 
                   is_const=True)
    ## trust-routing-protocol.h (module 'trust'): bool ns3::trust::RoutingProtocol::GetGratuitousReplyFlag() const [member function]
    cls.add_method('GetGratuitousReplyFlag', 
                   'bool', 
                   [], 
                   is_const=True)
    ## trust-routing-protocol.h (module 'trust'): bool ns3::trust::RoutingProtocol::GetHelloEnable() const [member function]
    cls.add_method('GetHelloEnable', 
                   'bool', 
                   [], 
                   is_const=True)
    ## trust-routing-protocol.h (module 'trust'): uint32_t ns3::trust::RoutingProtocol::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## trust-routing-protocol.h (module 'trust'): ns3::Time ns3::trust::RoutingProtocol::GetMaxQueueTime() const [member function]
    cls.add_method('GetMaxQueueTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## trust-routing-protocol.h (module 'trust'): static ns3::TypeId ns3::trust::RoutingProtocol::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## trust-routing-protocol.h (module 'trust'): void ns3::trust::RoutingProtocol::NotifyAddAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyAddAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   is_virtual=True)
    ## trust-routing-protocol.h (module 'trust'): void ns3::trust::RoutingProtocol::NotifyInterfaceDown(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceDown', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   is_virtual=True)
    ## trust-routing-protocol.h (module 'trust'): void ns3::trust::RoutingProtocol::NotifyInterfaceUp(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceUp', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   is_virtual=True)
    ## trust-routing-protocol.h (module 'trust'): void ns3::trust::RoutingProtocol::NotifyRemoveAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyRemoveAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   is_virtual=True)
    ## trust-routing-protocol.h (module 'trust'): void ns3::trust::RoutingProtocol::PrintRoutingTable(ns3::Ptr<ns3::OutputStreamWrapper> stream, ns3::Time::Unit unit=::ns3::Time::Unit::S) const [member function]
    cls.add_method('PrintRoutingTable', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream'), param('ns3::Time::Unit', 'unit', default_value='::ns3::Time::Unit::S')], 
                   is_const=True, is_virtual=True)
    ## trust-routing-protocol.h (module 'trust'): bool ns3::trust::RoutingProtocol::RouteInput(ns3::Ptr<const ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<const ns3::NetDevice> idev, ns3::Ipv4RoutingProtocol::UnicastForwardCallback ucb, ns3::Ipv4RoutingProtocol::MulticastForwardCallback mcb, ns3::Ipv4RoutingProtocol::LocalDeliverCallback lcb, ns3::Ipv4RoutingProtocol::ErrorCallback ecb) [member function]
    cls.add_method('RouteInput', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice const >', 'idev'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4Route >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ucb'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4MulticastRoute >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'mcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, unsigned int, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'lcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ecb')], 
                   is_virtual=True)
    ## trust-routing-protocol.h (module 'trust'): ns3::Ptr<ns3::Ipv4Route> ns3::trust::RoutingProtocol::RouteOutput(ns3::Ptr<ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<ns3::NetDevice> oif, ns3::Socket::SocketErrno & sockerr) [member function]
    cls.add_method('RouteOutput', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice >', 'oif'), param('ns3::Socket::SocketErrno &', 'sockerr')], 
                   is_virtual=True)
    ## trust-routing-protocol.h (module 'trust'): void ns3::trust::RoutingProtocol::SetBroadcastEnable(bool f) [member function]
    cls.add_method('SetBroadcastEnable', 
                   'void', 
                   [param('bool', 'f')])
    ## trust-routing-protocol.h (module 'trust'): void ns3::trust::RoutingProtocol::SetDestinationOnlyFlag(bool f) [member function]
    cls.add_method('SetDestinationOnlyFlag', 
                   'void', 
                   [param('bool', 'f')])
    ## trust-routing-protocol.h (module 'trust'): void ns3::trust::RoutingProtocol::SetGratuitousReplyFlag(bool f) [member function]
    cls.add_method('SetGratuitousReplyFlag', 
                   'void', 
                   [param('bool', 'f')])
    ## trust-routing-protocol.h (module 'trust'): void ns3::trust::RoutingProtocol::SetHelloEnable(bool f) [member function]
    cls.add_method('SetHelloEnable', 
                   'void', 
                   [param('bool', 'f')])
    ## trust-routing-protocol.h (module 'trust'): void ns3::trust::RoutingProtocol::SetIpv4(ns3::Ptr<ns3::Ipv4> ipv4) [member function]
    cls.add_method('SetIpv4', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4 >', 'ipv4')], 
                   is_virtual=True)
    ## trust-routing-protocol.h (module 'trust'): void ns3::trust::RoutingProtocol::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## trust-routing-protocol.h (module 'trust'): void ns3::trust::RoutingProtocol::SetMaxQueueTime(ns3::Time t) [member function]
    cls.add_method('SetMaxQueueTime', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## trust-routing-protocol.h (module 'trust'): ns3::trust::RoutingProtocol::TRUST_PORT [variable]
    cls.add_static_attribute('TRUST_PORT', 'uint32_t const', is_const=True)
    ## trust-routing-protocol.h (module 'trust'): void ns3::trust::RoutingProtocol::DoInitialize() [member function]
    cls.add_method('DoInitialize', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
...
def register_Ns3TrustRoutingTable_methods(root_module, cls):
    ## trust-rtable.h (module 'trust'): ns3::trust::RoutingTable::RoutingTable(ns3::trust::RoutingTable const & arg0) [constructor]
    cls.add_constructor([param('ns3::trust::RoutingTable const &', 'arg0')])
    ## trust-rtable.h (module 'trust'): ns3::trust::RoutingTable::RoutingTable(ns3::Time t) [constructor]
    cls.add_constructor([param('ns3::Time', 't')])
    ## trust-rtable.h (module 'trust'): bool ns3::trust::RoutingTable::AddRoute(ns3::trust::RoutingTableEntry & r) [member function]
    cls.add_method('AddRoute', 
                   'bool', 
                   [param('ns3::trust::RoutingTableEntry &', 'r')])
    ## trust-rtable.h (module 'trust'): void ns3::trust::RoutingTable::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## trust-rtable.h (module 'trust'): void ns3::trust::RoutingTable::DeleteAllRoutesFromInterface(ns3::Ipv4InterfaceAddress iface) [member function]
    cls.add_method('DeleteAllRoutesFromInterface', 
                   'void', 
                   [param('ns3::Ipv4InterfaceAddress', 'iface')])
    ## trust-rtable.h (module 'trust'): bool ns3::trust::RoutingTable::DeleteRoute(ns3::Ipv4Address dst) [member function]
    cls.add_method('DeleteRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## trust-rtable.h (module 'trust'): ns3::Time ns3::trust::RoutingTable::GetBadLinkLifetime() const [member function]
    cls.add_method('GetBadLinkLifetime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## trust-rtable.h (module 'trust'): void ns3::trust::RoutingTable::GetListOfDestinationWithNextHop(ns3::Ipv4Address nextHop, std::map<ns3::Ipv4Address, unsigned int, std::less<ns3::Ipv4Address>, std::allocator<std::pair<const ns3::Ipv4Address, unsigned int> > > & unreachable) [member function]
    ...
    ## trust-rtable.h (module 'trust'): void ns3::trust::RoutingTable::InvalidateRoutesWithDst(std::map<ns3::Ipv4Address, unsigned int, std::less<ns3::Ipv4Address>, std::allocator<std::pair<const ns3::Ipv4Address, unsigned int> > > const & unreachable) [member function]
    cls.add_method('InvalidateRoutesWithDst', 
                   'void', 
                   [param('std::map< ns3::Ipv4Address, unsigned int > const &', 'unreachable')])
    ## trust-rtable.h (module 'trust'): bool ns3::trust::RoutingTable::LookupRoute(ns3::Ipv4Address dst, ns3::trust::RoutingTableEntry & rt) [member function]
    cls.add_method('LookupRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::trust::RoutingTableEntry &', 'rt')])
    ## trust-rtable.h (module 'trust'): bool ns3::trust::RoutingTable::LookupValidRoute(ns3::Ipv4Address dst, ns3::trust::RoutingTableEntry & rt) [member function]
    cls.add_method('LookupValidRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::trust::RoutingTableEntry &', 'rt')])
    ## trust-rtable.h (module 'trust'): bool ns3::trust::RoutingTable::MarkLinkAsUnidirectional(ns3::Ipv4Address neighbor, ns3::Time blacklistTimeout) [member function]
    cls.add_method('MarkLinkAsUnidirectional', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'neighbor'), param('ns3::Time', 'blacklistTimeout')])
    ## trust-rtable.h (module 'trust'): void ns3::trust::RoutingTable::Print(ns3::Ptr<ns3::OutputStreamWrapper> stream) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream')], 
                   is_const=True)
    ## trust-rtable.h (module 'trust'): void ns3::trust::RoutingTable::Purge() [member function]
    cls.add_method('Purge', 
                   'void', 
                   [])
    ## trust-rtable.h (module 'trust'): void ns3::trust::RoutingTable::SetBadLinkLifetime(ns3::Time t) [member function]
    cls.add_method('SetBadLinkLifetime', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## trust-rtable.h (module 'trust'): bool ns3::trust::RoutingTable::SetEntryState(ns3::Ipv4Address dst, ns3::trust::RouteFlags state) [member function]
    cls.add_method('SetEntryState', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::trust::RouteFlags', 'state')])
    ## trust-rtable.h (module 'trust'): bool ns3::trust::RoutingTable::Update(ns3::trust::RoutingTableEntry & rt) [member function]
    cls.add_method('Update', 
                   'bool', 
                   [param('ns3::trust::RoutingTableEntry &', 'rt')])
    return

def register_Ns3TrustRoutingTableEntry_methods(root_module, cls):
    ## trust-rtable.h (module 'trust'): ns3::trust::RoutingTableEntry::RoutingTableEntry(ns3::trust::RoutingTableEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::trust::RoutingTableEntry const &', 'arg0')])
    ## trust-rtable.h (module 'trust'): ns3::trust::RoutingTableEntry::RoutingTableEntry(ns3::Ptr<ns3::NetDevice> dev=0, ns3::Ipv4Address dst=ns3::Ipv4Address(), bool vSeqNo=false, uint32_t seqNo=0, ns3::Ipv4InterfaceAddress iface=ns3::Ipv4InterfaceAddress(), uint16_t hops=0, ns3::Ipv4Address nextHop=ns3::Ipv4Address(), ns3::Time lifetime=ns3::Simulator::Now()) [constructor]
    ...
    ## trust-rtable.h (module 'trust'): void ns3::trust::RoutingTableEntry::DeleteAllPrecursors() [member function]
    cls.add_method('DeleteAllPrecursors', 
                   'void', 
                   [])
    ## trust-rtable.h (module 'trust'): bool ns3::trust::RoutingTableEntry::DeletePrecursor(ns3::Ipv4Address id) [member function]
    cls.add_method('DeletePrecursor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id')])
    ## trust-rtable.h (module 'trust'): ns3::Time ns3::trust::RoutingTableEntry::GetBlacklistTimeout() const [member function]
    cls.add_method('GetBlacklistTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## trust-rtable.h (module 'trust'): ns3::Ipv4Address ns3::trust::RoutingTableEntry::GetDestination() const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## trust-rtable.h (module 'trust'): ns3::trust::RouteFlags ns3::trust::RoutingTableEntry::GetFlag() const [member function]
    cls.add_method('GetFlag', 
                   'ns3::trust::RouteFlags', 
                   [], 
                   is_const=True)
    ## trust-rtable.h (module 'trust'): uint16_t ns3::trust::RoutingTableEntry::GetHop() const [member function]
    cls.add_method('GetHop', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## trust-rtable.h (module 'trust'): ns3::Ipv4InterfaceAddress ns3::trust::RoutingTableEntry::GetInterface() const [member function]
    cls.add_method('GetInterface', 
                   'ns3::Ipv4InterfaceAddress', 
                   [], 
                   is_const=True)
    ## trust-rtable.h (module 'trust'): ns3::Time ns3::trust::RoutingTableEntry::GetLifeTime() const [member function]
    cls.add_method('GetLifeTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## trust-rtable.h (module 'trust'): ns3::Ipv4Address ns3::trust::RoutingTableEntry::GetNextHop() const [member function]
    cls.add_method('GetNextHop', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## trust-rtable.h (module 'trust'): ns3::Ptr<ns3::NetDevice> ns3::trust::RoutingTableEntry::GetOutputDevice() const [member function]
    cls.add_method('GetOutputDevice', 
                   'ns3::Ptr< ns3::NetDevice >', 
                   [], 
                   is_const=True)
    ## trust-rtable.h (module 'trust'): void ns3::trust::RoutingTableEntry::GetPrecursors(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & prec) const [member function]
    cls.add_method('GetPrecursors', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address > &', 'prec')], 
                   is_const=True)
    ## trust-rtable.h (module 'trust'): ns3::Ptr<ns3::Ipv4Route> ns3::trust::RoutingTableEntry::GetRoute() const [member function]
    cls.add_method('GetRoute', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [], 
                   is_const=True)
    ## trust-rtable.h (module 'trust'): uint8_t ns3::trust::RoutingTableEntry::GetRreqCnt() const [member function]
    cls.add_method('GetRreqCnt', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## trust-rtable.h (module 'trust'): uint32_t ns3::trust::RoutingTableEntry::GetSeqNo() const [member function]
    cls.add_method('GetSeqNo', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## trust-rtable.h (module 'trust'): bool ns3::trust::RoutingTableEntry::GetValidSeqNo() const [member function]
    cls.add_method('GetValidSeqNo', 
                   'bool', 
                   [], 
                   is_const=True)
    ## trust-rtable.h (module 'trust'): void ns3::trust::RoutingTableEntry::IncrementRreqCnt() [member function]
    cls.add_method('IncrementRreqCnt', 
                   'void', 
                   [])
    ## trust-rtable.h (module 'trust'): bool ns3::trust::RoutingTableEntry::InsertPrecursor(ns3::Ipv4Address id) [member function]
    cls.add_method('InsertPrecursor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id')])
    ## trust-rtable.h (module 'trust'): void ns3::trust::RoutingTableEntry::Invalidate(ns3::Time badLinkLifetime) [member function]
    cls.add_method('Invalidate', 
                   'void', 
                   [param('ns3::Time', 'badLinkLifetime')])
    ## trust-rtable.h (module 'trust'): bool ns3::trust::RoutingTableEntry::IsPrecursorListEmpty() const [member function]
    cls.add_method('IsPrecursorListEmpty', 
                   'bool', 
                   [], 
                   is_const=True)
    ## trust-rtable.h (module 'trust'): bool ns3::trust::RoutingTableEntry::IsUnidirectional() const [member function]
    cls.add_method('IsUnidirectional', 
                   'bool', 
                   [], 
                   is_const=True)
    ## trust-rtable.h (module 'trust'): bool ns3::trust::RoutingTableEntry::LookupPrecursor(ns3::Ipv4Address id) [member function]
    cls.add_method('LookupPrecursor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id')])
    ## trust-rtable.h (module 'trust'): void ns3::trust::RoutingTableEntry::Print(ns3::Ptr<ns3::OutputStreamWrapper> stream) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream')], 
                   is_const=True)
    ## trust-rtable.h (module 'trust'): void ns3::trust::RoutingTableEntry::SetBlacklistTimeout(ns3::Time t) [member function]
    cls.add_method('SetBlacklistTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## trust-rtable.h (module 'trust'): void ns3::trust::RoutingTableEntry::SetFlag(ns3::trust::RouteFlags flag) [member function]
    cls.add_method('SetFlag', 
                   'void', 
                   [param('ns3::trust::RouteFlags', 'flag')])
    ## trust-rtable.h (module 'trust'): void ns3::trust::RoutingTableEntry::SetHop(uint16_t hop) [member function]
    cls.add_method('SetHop', 
                   'void', 
                   [param('uint16_t', 'hop')])
    ## trust-rtable.h (module 'trust'): void ns3::trust::RoutingTableEntry::SetInterface(ns3::Ipv4InterfaceAddress iface) [member function]
    cls.add_method('SetInterface', 
                   'void', 
                   [param('ns3::Ipv4InterfaceAddress', 'iface')])
    ## trust-rtable.h (module 'trust'): void ns3::trust::RoutingTableEntry::SetLifeTime(ns3::Time lt) [member function]
    cls.add_method('SetLifeTime', 
                   'void', 
                   [param('ns3::Time', 'lt')])
    ## trust-rtable.h (module 'trust'): void ns3::trust::RoutingTableEntry::SetNextHop(ns3::Ipv4Address nextHop) [member function]
    cls.add_method('SetNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'nextHop')])
    ## trust-rtable.h (module 'trust'): void ns3::trust::RoutingTableEntry::SetOutputDevice(ns3::Ptr<ns3::NetDevice> dev) [member function]
    cls.add_method('SetOutputDevice', 
                   'void', 
                   [param('ns3::Ptr< ns3::NetDevice >', 'dev')])
    ## trust-rtable.h (module 'trust'): void ns3::trust::RoutingTableEntry::SetRoute(ns3::Ptr<ns3::Ipv4Route> r) [member function]
    cls.add_method('SetRoute', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4Route >', 'r')])
    ## trust-rtable.h (module 'trust'): void ns3::trust::RoutingTableEntry::SetRreqCnt(uint8_t n) [member function]
    cls.add_method('SetRreqCnt', 
                   'void', 
                   [param('uint8_t', 'n')])
    ## trust-rtable.h (module 'trust'): void ns3::trust::RoutingTableEntry::SetSeqNo(uint32_t sn) [member function]
    cls.add_method('SetSeqNo', 
                   'void', 
                   [param('uint32_t', 'sn')])
    ## trust-rtable.h (module 'trust'): void ns3::trust::RoutingTableEntry::SetUnidirectional(bool u) [member function]
    cls.add_method('SetUnidirectional', 
                   'void', 
                   [param('bool', 'u')])
    ## trust-rtable.h (module 'trust'): void ns3::trust::RoutingTableEntry::SetValidSeqNo(bool s) [member function]
    cls.add_method('SetValidSeqNo', 
                   'void', 
                   [param('bool', 's')])
    ## trust-rtable.h (module 'trust'): ns3::trust::RoutingTableEntry::m_ackTimer [variable]
    cls.add_instance_attribute('m_ackTimer', 'ns3::Timer', is_const=False)
    return

def register_Ns3TrustRrepAckHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## trust-packet.h (module 'trust'): ns3::trust::RrepAckHeader::RrepAckHeader(ns3::trust::RrepAckHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::trust::RrepAckHeader const &', 'arg0')])
    ## trust-packet.h (module 'trust'): ns3::trust::RrepAckHeader::RrepAckHeader() [constructor]
    cls.add_constructor([])
    ## trust-packet.h (module 'trust'): uint32_t ns3::trust::RrepAckHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## trust-packet.h (module 'trust'): ns3::TypeId ns3::trust::RrepAckHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## trust-packet.h (module 'trust'): uint32_t ns3::trust::RrepAckHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## trust-packet.h (module 'trust'): static ns3::TypeId ns3::trust::RrepAckHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## trust-packet.h (module 'trust'): void ns3::trust::RrepAckHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## trust-packet.h (module 'trust'): void ns3::trust::RrepAckHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
...
def register_Ns3TrustRrepHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## trust-packet.h (module 'trust'): ns3::trust::RrepHeader::RrepHeader(ns3::trust::RrepHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::trust::RrepHeader const &', 'arg0')])
    ## trust-packet.h (module 'trust'): ns3::trust::RrepHeader::RrepHeader(uint8_t prefixSize=0, uint8_t hopCount=0, ns3::Ipv4Address dst=ns3::Ipv4Address(), uint32_t dstSeqNo=0, ns3::Ipv4Address origin=ns3::Ipv4Address(), ns3::Time lifetime=ns3::MilliSeconds(0)) [constructor]
    ...
    ## trust-packet.h (module 'trust'): uint32_t ns3::trust::RrepHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## trust-packet.h (module 'trust'): bool ns3::trust::RrepHeader::GetAckRequired() const [member function]
    cls.add_method('GetAckRequired', 
                   'bool', 
                   [], 
                   is_const=True)
    ## trust-packet.h (module 'trust'): ns3::Ipv4Address ns3::trust::RrepHeader::GetDst() const [member function]
    cls.add_method('GetDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## trust-packet.h (module 'trust'): uint32_t ns3::trust::RrepHeader::GetDstSeqno() const [member function]
    cls.add_method('GetDstSeqno', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## trust-packet.h (module 'trust'): uint8_t ns3::trust::RrepHeader::GetHopCount() const [member function]
    cls.add_method('GetHopCount', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## trust-packet.h (module 'trust'): ns3::TypeId ns3::trust::RrepHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## trust-packet.h (module 'trust'): ns3::Time ns3::trust::RrepHeader::GetLifeTime() const [member function]
    cls.add_method('GetLifeTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## trust-packet.h (module 'trust'): ns3::Ipv4Address ns3::trust::RrepHeader::GetOrigin() const [member function]
    cls.add_method('GetOrigin', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## trust-packet.h (module 'trust'): uint8_t ns3::trust::RrepHeader::GetPrefixSize() const [member function]
    cls.add_method('GetPrefixSize', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## trust-packet.h (module 'trust'): uint32_t ns3::trust::RrepHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## trust-packet.h (module 'trust'): static ns3::TypeId ns3::trust::RrepHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## trust-packet.h (module 'trust'): void ns3::trust::RrepHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## trust-packet.h (module 'trust'): void ns3::trust::RrepHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## trust-packet.h (module 'trust'): void ns3::trust::RrepHeader::SetAckRequired(bool f) [member function]
    cls.add_method('SetAckRequired', 
                   'void', 
                   [param('bool', 'f')])
    ## trust-packet.h (module 'trust'): void ns3::trust::RrepHeader::SetDst(ns3::Ipv4Address a) [member function]
    cls.add_method('SetDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'a')])
    ## trust-packet.h (module 'trust'): void ns3::trust::RrepHeader::SetDstSeqno(uint32_t s) [member function]
    cls.add_method('SetDstSeqno', 
                   'void', 
                   [param('uint32_t', 's')])
    ## trust-packet.h (module 'trust'): void ns3::trust::RrepHeader::SetHello(ns3::Ipv4Address src, uint32_t srcSeqNo, ns3::Time lifetime) [member function]
    cls.add_method('SetHello', 
                   'void', 
                   [param('ns3::Ipv4Address', 'src'), param('uint32_t', 'srcSeqNo'), param('ns3::Time', 'lifetime')])
    ## trust-packet.h (module 'trust'): void ns3::trust::RrepHeader::SetHopCount(uint8_t count) [member function]
    cls.add_method('SetHopCount', 
                   'void', 
                   [param('uint8_t', 'count')])
    ## trust-packet.h (module 'trust'): void ns3::trust::RrepHeader::SetLifeTime(ns3::Time t) [member function]
    cls.add_method('SetLifeTime', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## trust-packet.h (module 'trust'): void ns3::trust::RrepHeader::SetOrigin(ns3::Ipv4Address a) [member function]
    cls.add_method('SetOrigin', 
                   'void', 
                   [param('ns3::Ipv4Address', 'a')])
    ## trust-packet.h (module 'trust'): void ns3::trust::RrepHeader::SetPrefixSize(uint8_t sz) [member function]
    cls.add_method('SetPrefixSize', 
                   'void', 
                   [param('uint8_t', 'sz')])
    return

def register_Ns3TrustRreqHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## trust-packet.h (module 'trust'): ns3::trust::RreqHeader::RreqHeader(ns3::trust::RreqHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::trust::RreqHeader const &', 'arg0')])
    ## trust-packet.h (module 'trust'): ns3::trust::RreqHeader::RreqHeader(uint8_t flags=0, uint8_t reserved=0, uint8_t hopCount=0, uint32_t requestID=0, ns3::Ipv4Address dst=ns3::Ipv4Address(), uint32_t dstSeqNo=0, ns3::Ipv4Address origin=ns3::Ipv4Address(), uint32_t originSeqNo=0) [constructor]
    ...
    ## trust-packet.h (module 'trust'): uint32_t ns3::trust::RreqHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## trust-packet.h (module 'trust'): bool ns3::trust::RreqHeader::GetDestinationOnly() const [member function]
    cls.add_method('GetDestinationOnly', 
                   'bool', 
                   [], 
                   is_const=True)
    ## trust-packet.h (module 'trust'): ns3::Ipv4Address ns3::trust::RreqHeader::GetDst() const [member function]
    cls.add_method('GetDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## trust-packet.h (module 'trust'): uint32_t ns3::trust::RreqHeader::GetDstSeqno() const [member function]
    cls.add_method('GetDstSeqno', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## trust-packet.h (module 'trust'): bool ns3::trust::RreqHeader::GetGratuitousRrep() const [member function]
    cls.add_method('GetGratuitousRrep', 
                   'bool', 
                   [], 
                   is_const=True)
    ## trust-packet.h (module 'trust'): uint8_t ns3::trust::RreqHeader::GetHopCount() const [member function]
    cls.add_method('GetHopCount', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## trust-packet.h (module 'trust'): uint32_t ns3::trust::RreqHeader::GetId() const [member function]
    cls.add_method('GetId', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## trust-packet.h (module 'trust'): ns3::TypeId ns3::trust::RreqHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## trust-packet.h (module 'trust'): ns3::Ipv4Address ns3::trust::RreqHeader::GetOrigin() const [member function]
    cls.add_method('GetOrigin', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## trust-packet.h (module 'trust'): uint32_t ns3::trust::RreqHeader::GetOriginSeqno() const [member function]
    cls.add_method('GetOriginSeqno', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## trust-packet.h (module 'trust'): uint32_t ns3::trust::RreqHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## trust-packet.h (module 'trust'): static ns3::TypeId ns3::trust::RreqHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## trust-packet.h (module 'trust'): bool ns3::trust::RreqHeader::GetUnknownSeqno() const [member function]
    cls.add_method('GetUnknownSeqno', 
                   'bool', 
                   [], 
                   is_const=True)
    ## trust-packet.h (module 'trust'): void ns3::trust::RreqHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## trust-packet.h (module 'trust'): void ns3::trust::RreqHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## trust-packet.h (module 'trust'): void ns3::trust::RreqHeader::SetDestinationOnly(bool f) [member function]
    cls.add_method('SetDestinationOnly', 
                   'void', 
                   [param('bool', 'f')])
    ## trust-packet.h (module 'trust'): void ns3::trust::RreqHeader::SetDst(ns3::Ipv4Address a) [member function]
    cls.add_method('SetDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'a')])
    ## trust-packet.h (module 'trust'): void ns3::trust::RreqHeader::SetDstSeqno(uint32_t s) [member function]
    cls.add_method('SetDstSeqno', 
                   'void', 
                   [param('uint32_t', 's')])
    ## trust-packet.h (module 'trust'): void ns3::trust::RreqHeader::SetGratuitousRrep(bool f) [member function]
    cls.add_method('SetGratuitousRrep', 
                   'void', 
                   [param('bool', 'f')])
    ## trust-packet.h (module 'trust'): void ns3::trust::RreqHeader::SetHopCount(uint8_t count) [member function]
    cls.add_method('SetHopCount', 
                   'void', 
                   [param('uint8_t', 'count')])
    ## trust-packet.h (module 'trust'): void ns3::trust::RreqHeader::SetId(uint32_t id) [member function]
    cls.add_method('SetId', 
                   'void', 
                   [param('uint32_t', 'id')])
    ## trust-packet.h (module 'trust'): void ns3::trust::RreqHeader::SetOrigin(ns3::Ipv4Address a) [member function]
    cls.add_method('SetOrigin', 
                   'void', 
                   [param('ns3::Ipv4Address', 'a')])
    ## trust-packet.h (module 'trust'): void ns3::trust::RreqHeader::SetOriginSeqno(uint32_t s) [member function]
    cls.add_method('SetOriginSeqno', 
                   'void', 
                   [param('uint32_t', 's')])
    ## trust-packet.h (module 'trust'): void ns3::trust::RreqHeader::SetUnknownSeqno(bool f) [member function]
    cls.add_method('SetUnknownSeqno', 
                   'void', 
                   [param('bool', 'f')])
    return

def register_Ns3TrustTypeHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## trust-packet.h (module 'trust'): ns3::trust::TypeHeader::TypeHeader(ns3::trust::TypeHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::trust::TypeHeader const &', 'arg0')])
    ## trust-packet.h (module 'trust'): ns3::trust::TypeHeader::TypeHeader(ns3::trust::MessageType t=::ns3::trust::MessageType::TRUSTTYPE_RREQ) [constructor]
    cls.add_constructor([param('ns3::trust::MessageType', 't', default_value='::ns3::trust::MessageType::TRUSTTYPE_RREQ')])
    ## trust-packet.h (module 'trust'): uint32_t ns3::trust::TypeHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## trust-packet.h (module 'trust'): ns3::trust::MessageType ns3::trust::TypeHeader::Get() const [member function]
    cls.add_method('Get', 
                   'ns3::trust::MessageType', 
                   [], 
                   is_const=True)
    ## trust-packet.h (module 'trust'): ns3::TypeId ns3::trust::TypeHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## trust-packet.h (module 'trust'): uint32_t ns3::trust::TypeHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## trust-packet.h (module 'trust'): static ns3::TypeId ns3::trust::TypeHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## trust-packet.h (module 'trust'): bool ns3::trust::TypeHeader::IsValid() const [member function]
    cls.add_method('IsValid', 
                   'bool', 
                   [], 
                   is_const=True)
    ## trust-packet.h (module 'trust'): void ns3::trust::TypeHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## trust-packet.h (module 'trust'): void ns3::trust::TypeHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
...
def register_functions(root_module):
    ...
    register_functions_ns3_trust(module.get_submodule('trust'), root_module)
    return
...
def register_functions_ns3_trust(module, root_module):
    return
