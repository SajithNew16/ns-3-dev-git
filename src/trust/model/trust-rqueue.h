 ...
 */
#ifndef TRUST_RQUEUE_H
#define TRUST_RQUEUE_H
...
/**
 * \ingroup trust
 * \brief TRUST route request queue
 *
 * Since TRUST is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
