...
/**
 * \defgroup trust TRUST Routing
 *
 * This section documents the API of the ns-3 TRUST module. For a generic functional description, please refer to the ns-3 manual.
 */
