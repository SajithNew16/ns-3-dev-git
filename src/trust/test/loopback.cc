 ...
 * \ingroup trust
 *
 * \brief TRUST loopback UDP echo test case
 */
 ...
 * \ingroup tests
 *
 * \brief TRUST Loopback test suite
 */
class TrustLoopbackTestSuite : public TestSuite
{
public:
  TrustLoopbackTestSuite () : TestSuite ("routing-trust-loopback", SYSTEM)
  {
    SetDataDir (NS_TEST_SOURCEDIR);
    // UDP Echo loopback test case
    AddTestCase (new LoopbackTestCase (), TestCase::QUICK);
  }
} g_trustLoopbackTestSuite; ///< the test suite
