...
NS_LOG_COMPONENT_DEFINE ("Trust9nblackhole1n100s");
...
// Set Mobility for all nodes
  ...
  AnimationInterface anim ("trust9nblackhole1n100s.xml"); // Mandatory
...
//  anim.UpdateNodeColor (4,0,0,0);
  ...
  Ptr<OutputStreamWrapper> routingStream = Create<OutputStreamWrapper> ("trust9nblackhole1n100s.routes", std::ios::out);
...
//
  ...
  for (std::map<FlowId, FlowMonitor::FlowStats>::const_iterator i = stats.begin (); i != stats.end (); ++i)
    ...
    Ipv4FlowClassifier::FiveTuple t = classifier->FindFlow (i->first);
      if ((t.sourceAddress=="10.0.0.2" && t.destinationAddress == "10.0.0.5"))
      {
  ...
  monitor->SerializeToXmlFile("trust9nblackhole1n100sflow.flowmon", true, true);
