...
NS_LOG_COMPONENT_DEFINE ("Trust3nblackhole2n100s");
...
// Set Mobility for all nodes
  ...
  AnimationInterface anim ("trust3nblackhole2n100s.xml"); // Mandatory
...
//
  ...
  monitor->SerializeToXmlFile("trust3nblackhole2n100s.flowmon", true, true);
