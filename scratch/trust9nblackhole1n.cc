...
NS_LOG_COMPONENT_DEFINE ("Trust9nblackhole1n");
...
// Set Mobility for all nodes
  ...
  AnimationInterface anim ("trust9nblackhole1n.xml"); // Mandatory
...
//  anim.UpdateNodeColor (4,0,0,0);
  ...
  Ptr<OutputStreamWrapper> routingStream = Create<OutputStreamWrapper> ("trust9nblackhole1n.routes", std::ios::out);
...
//
  ...
  monitor->SerializeToXmlFile("trust9nblackhole1nflow.flowmon", true, true);
