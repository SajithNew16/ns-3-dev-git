...
NS_LOG_COMPONENT_DEFINE ("Trust8nblackhole2n100s");
...
// Set Mobility for all nodes
  ...
  AnimationInterface anim ("trust8nblackhole2n100s.xml"); // Mandatory
  ...
  AnimationInterface::SetConstantPosition (c.Get (5), 500, 350);
  AnimationInterface::SetConstantPosition (c.Get (6), 500, 450);
  AnimationInterface::SetConstantPosition (c.Get (7), 600, 450);
  AnimationInterface::SetConstantPosition (c.Get (8), 800, 650);
  AnimationInterface::SetConstantPosition (c.Get (9), 700, 550);
  ...
  anim.EnablePacketMetadata(true);
      ...
      Ptr<OutputStreamWrapper> routingStream = Create<OutputStreamWrapper> ("trust8nblackhole2n100s.routes", std::ios::out);
...
//
  ...
  monitor->SerializeToXmlFile("trust8nblackhole2n100s.flowmon", true, true);
