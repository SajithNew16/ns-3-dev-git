...
// Set Mobility for all nodes
  ...
  AnimationInterface anim ("trustblackhole12.xml"); // Mandatory
  ...
  anim.UpdateNodeColor (9,0,0,0);
  anim.UpdateNodeColor (8,0,0,0);
  anim.UpdateNodeColor (10,0,0,0);
  anim.UpdateNodeColor (11,0,0,0);
...
//
  ...
  monitor->SerializeToXmlFile("trustmal12.flowmon", true, true);
